 ...
 */
class Version20180108123654 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE hair (id INTEGER NOT NULL, short_code VARCHAR(5) NOT NULL, label VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__candidate AS SELECT id, language_id, eye_id, size FROM candidate');
        ...
        $this->addSql('INSERT INTO candidate (id, language_id, eye_id, size) SELECT id, language_id, eye_id, size FROM __temp__candidate');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__candidate AS SELECT id, language_id, eye_id, size FROM candidate');
        $this->addSql('DROP TABLE candidate');
        $this->addSql('CREATE TABLE candidate (id INTEGER NOT NULL, language_id INTEGER DEFAULT NULL, eye_id INTEGER DEFAULT NULL, size INTEGER NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO candidate (id, language_id, eye_id, size) SELECT id, language_id, eye_id, size FROM __temp__candidate');
        $this->addSql('DROP TABLE __temp__candidate');
        $this->addSql('CREATE INDEX IDX_C8B28E4482F1BAF4 ON candidate (language_id)');
        $this->addSql('CREATE INDEX IDX_C8B28E4488C1A6E7 ON candidate (eye_id)');
