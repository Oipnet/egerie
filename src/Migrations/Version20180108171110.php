 ...
 */
class Version20180108171110 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE contact (id INTEGER NOT NULL, subject VARCHAR(255) NOT NULL, content CLOB NOT NULL, author VARCHAR(255) NOT NULL, created DATETIME NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('DROP INDEX IDX_C8B28E442A89600A');
        $this->addSql('DROP INDEX IDX_C8B28E4482F1BAF4');
        $this->addSql('DROP INDEX IDX_C8B28E4488C1A6E7');
        $this->addSql('CREATE TEMPORARY TABLE __temp__candidate AS SELECT id, language_id, eye_id, hair_id, size FROM candidate');
        $this->addSql('DROP TABLE candidate');
        $this->addSql('CREATE TABLE candidate (id INTEGER NOT NULL, language_id INTEGER DEFAULT NULL, eye_id INTEGER DEFAULT NULL, hair_id INTEGER DEFAULT NULL, size INTEGER NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_C8B28E4482F1BAF4 FOREIGN KEY (language_id) REFERENCES language (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C8B28E4488C1A6E7 FOREIGN KEY (eye_id) REFERENCES eye (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C8B28E442A89600A FOREIGN KEY (hair_id) REFERENCES hair (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO candidate (id, language_id, eye_id, hair_id, size) SELECT id, language_id, eye_id, hair_id, size FROM __temp__candidate');
        $this->addSql('DROP TABLE __temp__candidate');
        $this->addSql('CREATE INDEX IDX_C8B28E442A89600A ON candidate (hair_id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__candidate AS SELECT id, language_id, eye_id, hair_id, size FROM candidate');
        $this->addSql('DROP TABLE candidate');
        $this->addSql('CREATE TABLE candidate (id INTEGER NOT NULL, language_id INTEGER DEFAULT NULL, eye_id INTEGER DEFAULT NULL, hair_id INTEGER DEFAULT NULL, size INTEGER NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO candidate (id, language_id, eye_id, hair_id, size) SELECT id, language_id, eye_id, hair_id, size FROM __temp__candidate');
        $this->addSql('DROP TABLE __temp__candidate');
        $this->addSql('CREATE INDEX IDX_C8B28E4482F1BAF4 ON candidate (language_id)');
        $this->addSql('CREATE INDEX IDX_C8B28E4488C1A6E7 ON candidate (eye_id)');
